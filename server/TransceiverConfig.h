...
public final class TransceiverConfig {
	...
	public static final String PEER_FILE = "peerfile";
	public static final String PORT = "port";
	public static final String REGISTRY_FILE = "registryfile";
	public static final String PLUGIN_FILE = "pluginfile";
	...
	public static final String MAXPEERS = "maxpeers";
